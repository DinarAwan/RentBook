            ...
            @endif
                    ...
                    <form action="/book-edit/{{ $book->slug }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($book->cover!='')
                                <img src="{{ asset('storage/cover/'.$book->cover) }}" alt="" width="80px">
                            @else
                            <img src="{{ asset('images/a4858ba1c4ae4beef4a0466f5298b1fa.jpg') }}" alt="" width="80px">
                            @endif
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="currentCategory" class="form-label">Category Saat Ini</label>
                            <ul>
